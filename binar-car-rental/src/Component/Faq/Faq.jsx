                ...
                <div className="row mt-4">
                    ...
                    <div className="col-lg-6">
                        <div className="row mx-1">
                            <div onClick={() => faq1 == 'none'? setFaq1('flex') : setFaq1('none')} className="faq-item card pt-3">
                            ...
                            <div onClick={() => faq2 == 'none'? setFaq2('flex') : setFaq2('none')} className=" faq-item card pt-3">
                            ...
                            <div onClick={() => faq3 == 'none'? setFaq3('flex') : setFaq3('none')} className="faq-item card pt-3">
                            ...
                            <div onClick={() => faq4 == 'none'? setFaq4('flex') : setFaq4('none')} className="faq-item card pt-3">
                            ...
                            <div onClick={() => faq5 == 'none'? setFaq5('flex') : setFaq5('none')} className="faq-item card pt-3">
